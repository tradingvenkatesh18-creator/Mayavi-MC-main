            ...
            >
              ...
              <div className="mt-5 pt-4 border-t border-white/5 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-full font-mono text-[8px] tracking-widest uppercase border transition-all duration-300 cursor-pointer flex items-center space-x-1.5 ${
                    isBtsOpen
